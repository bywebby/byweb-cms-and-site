...
{{--                                    </div>--}}
{{--                                    <ul>--}}
{{--                                        <li><a href="/razrabotka-saita"><i class="fa fa-screwdriver-wrench"></i>Php-программист</a>--}}
{{--                                        </li>--}}
...
{{--                                        <li><a href="#"><i class="fa fa-house-flood-water-circle-arrow-right"></i>Интернет-портал</a>--}}
{{--                                        </li>--}}
{{--                                    </ul>--}}
{{--                                </div>--}}
